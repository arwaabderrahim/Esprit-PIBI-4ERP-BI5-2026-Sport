 ...
 * @status
 */
public class SA_clvf implements TalendJob {
	...
	private final String jobName = "SA_clvf";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SA_clvf.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class SA_clvfStruct implements routines.system.IPersistableRow<SA_clvfStruct> {
		final static byte[] commonByteArrayLock_PADEL_SA_clvf = new byte[0];
		static byte[] commonByteArray_PADEL_SA_clvf = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PADEL_SA_clvf.length) {
					if (length < 1024 && commonByteArray_PADEL_SA_clvf.length == 0) {
						commonByteArray_PADEL_SA_clvf = new byte[1024];
					} else {
						commonByteArray_PADEL_SA_clvf = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PADEL_SA_clvf, 0, length);
				strReturn = new String(commonByteArray_PADEL_SA_clvf, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PADEL_SA_clvf, 0, length);
				strReturn = new String(commonByteArray_PADEL_SA_clvf, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PADEL_SA_clvf) {
		 ...
		 * Compare keys
		 */
		public int compareTo(SA_clvfStruct other) {
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				SA_clvfStruct SA_clvf = new SA_clvfStruct();
				...
				String directory_tFileList_1 = "C:/Users/arwaa/Downloads/cl";
				final java.util.List<String> maskList_tFileList_1 = new java.util.ArrayList<String>();
				final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>();
				maskList_tFileList_1.add("cl*.xlsx");
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("SA_clvf", 3, 0);
					}
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "SA_clvf");
					}
					...
					String tableName_tDBOutput_1 = "SA_clvf";
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:S14P2tP2QywYdtO8TpVEzS3GyrJGbLXC0kYPrw==");
					...
					String insert_tDBOutput_1 = "INSERT INTO `" + "SA_clvf"
							+ "` (`Month`,`Week`,`Start_Date`,`End_Date`,`Event`,`Category`) VALUES (?,?,?,?,?,?)";
...
// # Outputs initialization
					SA_clvfStruct SA_clvf_tmp = new SA_clvfStruct();
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:26iXz/pi9/PkC4eFEc+SQsAkse1BPBHzROw+ww==");
							...
							for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
								...
								try {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "Week";

										row1.Week = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
												+ start_column_tFileInputExcel_1 + 1;
										curColName_tFileInputExcel_1 = "Event";

										row1.Event = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
									} else {
										row1.Event = null;
										emptyColumnCount_tFileInputExcel_1++;
									}
...
// # Filter conditions 
										...
										row1.Month != null
											...
											SA_clvf_tmp.Month = row1.Month;
											SA_clvf_tmp.Week = row1.Week;
											SA_clvf_tmp.Start_Date = row1.Start_Date;
											SA_clvf_tmp.End_Date = row1.End_Date;
											SA_clvf_tmp.Event = row1.Event;
											SA_clvf_tmp.Category = row1.Category;
											SA_clvf = SA_clvf_tmp;
...
// Start of branch "SA_clvf"
									if (SA_clvf != null) {
										...
										if (SA_clvf.Month == null) {
											pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(1, SA_clvf.Month);
										}

										if (SA_clvf.Week == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(2, SA_clvf.Week);
										}

										if (SA_clvf.Start_Date == null) {
											pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(3, SA_clvf.Start_Date);
										}

										if (SA_clvf.End_Date == null) {
											pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(4, SA_clvf.End_Date);
										}

										if (SA_clvf.Event == null) {
											pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(5, SA_clvf.Event);
										}

										if (SA_clvf.Category == null) {
											pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(6, SA_clvf.Category);
										}
...
// ###############################      
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "SA_clvf");
					}
	...
	public static void main(String[] args) {
		final SA_clvf SA_clvfClass = new SA_clvf();

		int exitCode = SA_clvfClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SA_clvf.class.getClassLoader()
					.getResourceAsStream("padel/sa_clvf_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SA_clvf.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SA_clvf");
		}
...
/************************************************************************************************
 * 77317 characters generated by Talend Open Studio for Data Integration on the
 * February 14, 2026 at 11:21:15 AM CET
 ************************************************************************************************/
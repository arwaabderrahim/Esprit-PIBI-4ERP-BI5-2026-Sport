...
package padel.sa_tr_offcial_0_1;
 ...
 * @status
 */
public class SA_tr_offcial implements TalendJob {
	...
	private final String jobName = "SA_tr_offcial";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SA_tr_offcial.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SA_tr_offcial.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class satestavrllllllStruct implements routines.system.IPersistableRow<satestavrllllllStruct> {
		final static byte[] commonByteArrayLock_PADEL_SA_tr_offcial = new byte[0];
		static byte[] commonByteArray_PADEL_SA_tr_offcial = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PADEL_SA_tr_offcial.length) {
					if (length < 1024 && commonByteArray_PADEL_SA_tr_offcial.length == 0) {
						commonByteArray_PADEL_SA_tr_offcial = new byte[1024];
					} else {
						commonByteArray_PADEL_SA_tr_offcial = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PADEL_SA_tr_offcial, 0, length);
				strReturn = new String(commonByteArray_PADEL_SA_tr_offcial, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PADEL_SA_tr_offcial, 0, length);
				strReturn = new String(commonByteArray_PADEL_SA_tr_offcial, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PADEL_SA_tr_offcial) {
		 ...
		 * Compare keys
		 */
		public int compareTo(satestavrllllllStruct other) {
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				satestavrllllllStruct satestavrllllll = new satestavrllllllStruct();
				...
				String directory_tFileList_1 = "C:/Users/arwaa/Downloads/testsa";
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("satestavrllllll", 3, 0);
					}
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "satestavrllllll");
					}
					...
					String tableName_tDBOutput_1 = "saavrelll";
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:RwZMkMmc8xun1WjAMUS3agTsw5RvBXuvCdLZgw==");
					...
					String insert_tDBOutput_1 = "INSERT INTO `" + "saavrelll"
...
// # Outputs initialization
					satestavrllllllStruct satestavrllllll_tmp = new satestavrllllllStruct();
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:VnGoTblPwjq4FfUes4tTSJBt6YYHEXodCHujtQ==");
							...
							for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
								...
								try {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										...
										row1.Points__Winner = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
...
// Start of branch "row1"
								if (row1 != null) {
									...
									{ // start of Var scope
										...
										satestavrllllll = null;

// # Output table : 'satestavrllllll'
// # Filter conditions 
										if (
										...
										row1.Match_type != null
											...
											satestavrllllll_tmp.Match_type = row1.Match_type;
											satestavrllllll_tmp.Team_1 = row1.Team_1;
											satestavrllllll_tmp.Team_2 = row1.Team_2;
											satestavrllllll_tmp.Winner = row1.Winner;
											satestavrllllll_tmp.Loser = row1.Loser;
											satestavrllllll_tmp.Score = row1.Score;
											satestavrllllll_tmp.Points__Winner = row1.Points__Winner;
											satestavrllllll_tmp.Prize__Winner = row1.Prize__Winner;
											satestavrllllll_tmp.Points__Loser = row1.Points__Loser;
											satestavrllllll_tmp.Prize__Loser = row1.Prize__Loser;
											satestavrllllll_tmp.Date = row1.Date;
											satestavrllllll_tmp.Tournament_Name = row1.Tournament_Name;
											satestavrllllll_tmp.Gender = row1.Gender;
											satestavrllllll = satestavrllllll_tmp;
...
// ###############################
									 ...
									 */
// Start of branch "satestavrllllll"
									if (satestavrllllll != null) {
										...
										if (satestavrllllll.Match_type == null) {
											pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(1, satestavrllllll.Match_type);
										}

										if (satestavrllllll.Team_1 == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, satestavrllllll.Team_1);
										}

										if (satestavrllllll.Team_2 == null) {
											pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(3, satestavrllllll.Team_2);
										}

										if (satestavrllllll.Winner == null) {
											pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(4, satestavrllllll.Winner);
										}

										if (satestavrllllll.Loser == null) {
											pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(5, satestavrllllll.Loser);
										}

										if (satestavrllllll.Score == null) {
											pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(6, satestavrllllll.Score);
										}

										if (satestavrllllll.Points__Winner == null) {
											pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(7, satestavrllllll.Points__Winner);
										}

										if (satestavrllllll.Prize__Winner == null) {
											pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(8, satestavrllllll.Prize__Winner);
										}

										if (satestavrllllll.Points__Loser == null) {
											pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(9, satestavrllllll.Points__Loser);
										}

										if (satestavrllllll.Prize__Loser == null) {
											pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(10, satestavrllllll.Prize__Loser);
										}

										if (satestavrllllll.Date != null) {
											date_tDBOutput_1 = satestavrllllll.Date.getTime();
										...
										if (satestavrllllll.Tournament_Name == null) {
											pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(12, satestavrllllll.Tournament_Name);
										}

										if (satestavrllllll.Gender == null) {
											pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(13, satestavrllllll.Gender);
										}
...
// ###############################      
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "satestavrllllll");
					}
	...
	public static void main(String[] args) {
		final SA_tr_offcial SA_tr_offcialClass = new SA_tr_offcial();

		int exitCode = SA_tr_offcialClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SA_tr_offcial.class.getClassLoader()
					.getResourceAsStream("padel/sa_tr_offcial_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SA_tr_offcial.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SA_tr_offcial");
		}
...
/************************************************************************************************
 * 92795 characters generated by Talend Open Studio for Data Integration on the
 * February 15, 2026 at 3:50:28 PM CET
 ************************************************************************************************/
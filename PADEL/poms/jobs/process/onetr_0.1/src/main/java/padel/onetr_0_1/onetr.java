 ...
 * @status
 */
public class onetr implements TalendJob {
	...
	private final String jobName = "onetr";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(onetr.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class onetrrrStruct implements routines.system.IPersistableRow<onetrrrStruct> {
		final static byte[] commonByteArrayLock_PADEL_onetr = new byte[0];
		static byte[] commonByteArray_PADEL_onetr = new byte[0];
		...
		public Float Prize__Winner;

		public Float getPrize__Winner() {
		...
		public Float Prize__Loser;

		public Float getPrize__Loser() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PADEL_onetr.length) {
					if (length < 1024 && commonByteArray_PADEL_onetr.length == 0) {
						commonByteArray_PADEL_onetr = new byte[1024];
					} else {
						commonByteArray_PADEL_onetr = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PADEL_onetr, 0, length);
				strReturn = new String(commonByteArray_PADEL_onetr, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PADEL_onetr, 0, length);
				strReturn = new String(commonByteArray_PADEL_onetr, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PADEL_onetr) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.Prize__Winner = null;
					} else {
						this.Prize__Winner = dis.readFloat();
					}
					...
					length = dis.readByte();
					if (length == -1) {
						this.Prize__Loser = null;
					} else {
						this.Prize__Loser = dis.readFloat();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.Prize__Winner == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeFloat(this.Prize__Winner);
				}
				...
				if (this.Prize__Loser == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeFloat(this.Prize__Loser);
				}
		...
		public String toString() {
			...
			sb.append(",Prize__Winner=" + String.valueOf(Prize__Winner));
		 ...
		 * Compare keys
		 */
		public int compareTo(onetrrrStruct other) {
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				onetrrrStruct onetrrr = new onetrrrStruct();
				...
				String directory_tFileList_1 = "C:/Users/arwaa/Downloads/2023 final";
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					String tableName_tDBOutput_1 = "onetrtotal";
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:vQWVGdMTed3a2NTvDAFCNSnrrT3ntNOA6VqI+w==");
					...
					java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("padel_analytics", null,
							null, new String[] { "TABLE" });
					boolean whetherExist_tDBOutput_1 = false;
					while (rsTable_tDBOutput_1.next()) {
						String table_tDBOutput_1 = rsTable_tDBOutput_1.getString("TABLE_NAME");
						if (table_tDBOutput_1.equalsIgnoreCase("onetrtotal")) {
					...
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`Match_Type` VARCHAR(255)  ,`Team_1` VARCHAR(255)  ,`Team_2` VARCHAR(255)  ,`Winner` VARCHAR(255)  ,`Loser` VARCHAR(255)  ,`Score` VARCHAR(255)  ,`Points__Winner` INT(255)  ,`Prize__Winner` FLOAT(255,3)  ,`Points__Loser` INT(255)  ,`Prize__Loser` FLOAT(255,4)  ,`Date` VARCHAR(255)  ,`Tournament_Name` VARCHAR(255)  ,`Gender` VARCHAR(255)  )");
					}

					String insert_tDBOutput_1 = "INSERT INTO `" + "onetrtotal"
...
// # Outputs initialization
					onetrrrStruct onetrrr_tmp = new onetrrrStruct();
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:q+MATrQ7xBt6FHkdGlI5LjyTf/Jel4E73Mx+lw==");
							...
							for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
								...
								try {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										...
										row1.Prize__Winner = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										...
										row1.Points__Loser = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
									} else {
									...
									if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
										...
										row1.Prize__Loser = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
									} else {
...
// # Output table : 'onetrrr'
										onetrrr_tmp.Match_Type = row1.Match_Type;
										onetrrr_tmp.Team_1 = row1.Team_1;
										onetrrr_tmp.Team_2 = row1.Team_2;
										onetrrr_tmp.Winner = row1.Winner;
										onetrrr_tmp.Loser = row1.Loser;
										onetrrr_tmp.Score = row1.Score;
										onetrrr_tmp.Points__Winner = row1.Points__Winner;
										onetrrr_tmp.Prize__Winner = row1.Prize__Winner;
										onetrrr_tmp.Points__Loser = row1.Points__Loser;
										onetrrr_tmp.Prize__Loser = row1.Prize__Loser;
										onetrrr_tmp.Date = row1.Date;
										onetrrr_tmp.Tournament_Name = row1.Tournament_Name;
										onetrrr_tmp.Gender = row1.Gender;
										onetrrr = onetrrr_tmp;
// ###############################
...
// Start of branch "onetrrr"
									if (onetrrr != null) {
										...
										if (onetrrr.Match_Type == null) {
											pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(1, onetrrr.Match_Type);
										}

										if (onetrrr.Team_1 == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, onetrrr.Team_1);
										}

										if (onetrrr.Team_2 == null) {
											pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(3, onetrrr.Team_2);
										}

										if (onetrrr.Winner == null) {
											pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(4, onetrrr.Winner);
										}

										if (onetrrr.Loser == null) {
											pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(5, onetrrr.Loser);
										}

										if (onetrrr.Score == null) {
											pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(6, onetrrr.Score);
										}

										if (onetrrr.Points__Winner == null) {
											pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(7, onetrrr.Points__Winner);
										}

										if (onetrrr.Prize__Winner == null) {
											pstmt_tDBOutput_1.setNull(8, java.sql.Types.FLOAT);
										} else {
											pstmt_tDBOutput_1.setFloat(8, onetrrr.Prize__Winner);
										}

										if (onetrrr.Points__Loser == null) {
											pstmt_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(9, onetrrr.Points__Loser);
										}

										if (onetrrr.Prize__Loser == null) {
											pstmt_tDBOutput_1.setNull(10, java.sql.Types.FLOAT);
										} else {
											pstmt_tDBOutput_1.setFloat(10, onetrrr.Prize__Loser);
										}

										if (onetrrr.Date == null) {
											pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(11, onetrrr.Date);
										}

										if (onetrrr.Tournament_Name == null) {
											pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(12, onetrrr.Tournament_Name);
										}

										if (onetrrr.Gender == null) {
											pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(13, onetrrr.Gender);
										}
...
// ###############################      
	...
	public static void main(String[] args) {
		final onetr onetrClass = new onetr();

		int exitCode = onetrClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = onetr.class.getClassLoader()
					.getResourceAsStream("padel/onetr_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = onetr.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : onetr");
		}
...
/************************************************************************************************
 * 90593 characters generated by Talend Open Studio for Data Integration on the
 * February 14, 2026 at 10:58:03 PM CET
 ************************************************************************************************/
...
package padel.sa_padel_infoo_0_1;
 ...
 * @status
 */
public class Sa_Padel_Infoo implements TalendJob {
	...
	private final String jobName = "Sa_Padel_Infoo";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Sa_Padel_Infoo.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Sa_Padel_Infoo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class sapadelinfoStruct implements routines.system.IPersistableRow<sapadelinfoStruct> {
		final static byte[] commonByteArrayLock_PADEL_Sa_Padel_Infoo = new byte[0];
		static byte[] commonByteArray_PADEL_Sa_Padel_Infoo = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PADEL_Sa_Padel_Infoo.length) {
					if (length < 1024 && commonByteArray_PADEL_Sa_Padel_Infoo.length == 0) {
						commonByteArray_PADEL_Sa_Padel_Infoo = new byte[1024];
					} else {
						commonByteArray_PADEL_Sa_Padel_Infoo = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PADEL_Sa_Padel_Infoo, 0, length);
				strReturn = new String(commonByteArray_PADEL_Sa_Padel_Infoo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PADEL_Sa_Padel_Infoo, 0, length);
				strReturn = new String(commonByteArray_PADEL_Sa_Padel_Infoo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PADEL_Sa_Padel_Infoo) {
		 ...
		 * Compare keys
		 */
		public int compareTo(sapadelinfoStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				sapadelinfoStruct sapadelinfo = new sapadelinfoStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "sapadelinfo");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:7kh2TDiJpJ8aJ+oBWna63QiNRpMTZITEiQOKOA==");
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`title` VARCHAR(62)  ,`handle` VARCHAR(62)  ,`vendor` VARCHAR(11)  ,`product_type` VARCHAR(10)  ,`tags` VARCHAR(31)  ,`created_at` DATETIME ,`price` FLOAT(5,2)  ,`sku` VARCHAR(5)  ,`image` VARCHAR(164)  ,`weight` VARCHAR(8)  ,`shape` VARCHAR(7)  ,`foam` VARCHAR(8)  ,`collection` VARCHAR(10)  ,`game_level` VARCHAR(13)  ,`frame` VARCHAR(7)  ,`surface` VARCHAR(6)  ,`professional_player` VARCHAR(8)  ,`color` VARCHAR(11)  ,`racket_type` VARCHAR(11)  ,`balance` VARCHAR(6)  ,`gender` VARCHAR(5)  ,`racket_cover` VARCHAR(3)  ,`player_name` VARCHAR(20)  )");
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "SA_Padel_Info_ofc"
...
// # Outputs initialization
				sapadelinfoStruct sapadelinfo_tmp = new sapadelinfoStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:9E5zv4iqY3PgmoIadgKdPee9MBhAk5n7KIvY8A==");
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.sku = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.sku = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// # Output table : 'sapadelinfo'
									sapadelinfo_tmp.title = row1.title;
									sapadelinfo_tmp.handle = row1.handle;
									sapadelinfo_tmp.vendor = row1.vendor;
									sapadelinfo_tmp.product_type = row1.product_type;
									sapadelinfo_tmp.tags = row1.tags;
									sapadelinfo_tmp.created_at = row1.created_at;
									sapadelinfo_tmp.price = row1.price;
									sapadelinfo_tmp.sku = row1.sku;
									sapadelinfo_tmp.image = row1.image;
									sapadelinfo_tmp.weight = row1.weight;
									sapadelinfo_tmp.shape = row1.shape;
									sapadelinfo_tmp.foam = row1.foam;
									sapadelinfo_tmp.collection = row1.collection;
									sapadelinfo_tmp.game_level = row1.game_level;
									sapadelinfo_tmp.frame = row1.frame;
									sapadelinfo_tmp.surface = row1.surface;
									sapadelinfo_tmp.professional_player = row1.professional_player;
									sapadelinfo_tmp.color = row1.color;
									sapadelinfo_tmp.racket_type = row1.racket_type;
									sapadelinfo_tmp.balance = row1.balance;
									sapadelinfo_tmp.gender = row1.gender;
									sapadelinfo_tmp.racket_cover = row1.racket_cover;
									sapadelinfo_tmp.player_name = row1.player_name;
									sapadelinfo = sapadelinfo_tmp;
// ###############################
...
// Start of branch "sapadelinfo"
								if (sapadelinfo != null) {
									...
									if (sapadelinfo.title == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(1, sapadelinfo.title);
									}

									if (sapadelinfo.handle == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, sapadelinfo.handle);
									}

									if (sapadelinfo.vendor == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, sapadelinfo.vendor);
									}

									if (sapadelinfo.product_type == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, sapadelinfo.product_type);
									}

									if (sapadelinfo.tags == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, sapadelinfo.tags);
									}

									if (sapadelinfo.created_at != null) {
										date_tDBOutput_1 = sapadelinfo.created_at.getTime();
									...
									if (sapadelinfo.price == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.FLOAT);
									} else {
										pstmt_tDBOutput_1.setFloat(7, sapadelinfo.price);
									}

									if (sapadelinfo.sku == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(8, sapadelinfo.sku);
									}

									if (sapadelinfo.image == null) {
										pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(9, sapadelinfo.image);
									}

									if (sapadelinfo.weight == null) {
										pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(10, sapadelinfo.weight);
									}

									if (sapadelinfo.shape == null) {
										pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(11, sapadelinfo.shape);
									}

									if (sapadelinfo.foam == null) {
										pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(12, sapadelinfo.foam);
									}

									if (sapadelinfo.collection == null) {
										pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(13, sapadelinfo.collection);
									}

									if (sapadelinfo.game_level == null) {
										pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(14, sapadelinfo.game_level);
									}

									if (sapadelinfo.frame == null) {
										pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(15, sapadelinfo.frame);
									}

									if (sapadelinfo.surface == null) {
										pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(16, sapadelinfo.surface);
									}

									if (sapadelinfo.professional_player == null) {
										pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(17, sapadelinfo.professional_player);
									}

									if (sapadelinfo.color == null) {
										pstmt_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(18, sapadelinfo.color);
									}

									if (sapadelinfo.racket_type == null) {
										pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(19, sapadelinfo.racket_type);
									}

									if (sapadelinfo.balance == null) {
										pstmt_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(20, sapadelinfo.balance);
									}

									if (sapadelinfo.gender == null) {
										pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(21, sapadelinfo.gender);
									}

									if (sapadelinfo.racket_cover == null) {
										pstmt_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(22, sapadelinfo.racket_cover);
									}

									if (sapadelinfo.player_name == null) {
										pstmt_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(23, sapadelinfo.player_name);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "sapadelinfo");
				}
	...
	public static void main(String[] args) {
		final Sa_Padel_Infoo Sa_Padel_InfooClass = new Sa_Padel_Infoo();

		int exitCode = Sa_Padel_InfooClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Sa_Padel_Infoo.class.getClassLoader()
					.getResourceAsStream("padel/sa_padel_infoo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Sa_Padel_Infoo.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Sa_Padel_Infoo");
		}
...
/************************************************************************************************
 * 102191 characters generated by Talend Open Studio for Data Integration on the
 * March 24, 2026 at 5:30:40 PM CET
 ************************************************************************************************/
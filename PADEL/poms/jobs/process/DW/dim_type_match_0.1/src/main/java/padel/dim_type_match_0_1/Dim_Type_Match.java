...
package padel.dim_type_match_0_1;
...
/**
 * Job: Dim_Type_Match Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Type_Match implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Type_Match";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Type_Match.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Type_Match.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Dim_Type_MatchStruct implements routines.system.IPersistableRow<Dim_Type_MatchStruct> {
    final static byte[] commonByteArrayLock_PADEL_Dim_Type_Match = new byte[0];
    static byte[] commonByteArray_PADEL_Dim_Type_Match = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.Id_type_match;
	...
	public boolean equals(Object obj) {
		...
		final Dim_Type_MatchStruct other = (Dim_Type_MatchStruct) obj;
		
						if (this.Id_type_match != other.Id_type_match)
							return false;
	...
	public void copyDataTo(Dim_Type_MatchStruct other) {
	...
	public void copyKeysDataTo(Dim_Type_MatchStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PADEL_Dim_Type_Match.length) {
				if(length < 1024 && commonByteArray_PADEL_Dim_Type_Match.length == 0) {
   					commonByteArray_PADEL_Dim_Type_Match = new byte[1024];
				} else {
   					commonByteArray_PADEL_Dim_Type_Match = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PADEL_Dim_Type_Match, 0, length);
			strReturn = new String(commonByteArray_PADEL_Dim_Type_Match, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PADEL_Dim_Type_Match, 0, length);
			strReturn = new String(commonByteArray_PADEL_Dim_Type_Match, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PADEL_Dim_Type_Match) {
     ...
     * Compare keys
     */
    public int compareTo(Dim_Type_MatchStruct other) {

		int returnValue = -1;
		
						returnValue = checkNullsAndCompare(this.Id_type_match, other.Id_type_match);
						if(returnValue != 0) {
							return returnValue;
						}
...
Dim_Type_MatchStruct Dim_Type_Match = new Dim_Type_MatchStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Dim_Type_Match");
					}
...
String tableName_tDBOutput_1 = "Dim_Type_Match";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:oufIgNzuBbHblwW0dMwsfi6VwAV+JjSiCTi6OQ==");
...
int count_tDBOutput_1=0;
                                ...
                                while(rsTable_tDBOutput_1.next()) {
                                    ...
                                    if(table_tDBOutput_1.equalsIgnoreCase("Dim_Type_Match")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Match_type` VARCHAR(255)  ,`Id_type_match` INT(10)   not null ,primary key(`Id_type_match`))");
                                }

				String insert_tDBOutput_1 = "INSERT INTO `" + "Dim_Type_Match" + "` (`Match_type`,`Id_type_match`) VALUES (?,?)";
...
Dim_Type_MatchStruct Dim_Type_Match_tmp = new Dim_Type_MatchStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:toPb+rUJSFFomFEqTOEkGNDCCtd22hL4IqqFbQ==");
...
// # Output table : 'Dim_Type_Match'
Dim_Type_Match_tmp.Match_type = row2.Match_type ;
Dim_Type_Match_tmp.Id_type_match = Numeric.sequence("s1",1,1) ;
Dim_Type_Match = Dim_Type_Match_tmp;
// ###############################
 ...
 */
// Start of branch "Dim_Type_Match"
if(Dim_Type_Match != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            if(Dim_Type_Match.Match_type == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, Dim_Type_Match.Match_type);
}

                            pstmt_tDBOutput_1.setInt(2, Dim_Type_Match.Id_type_match);
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Dim_Type_Match");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Type_Match Dim_Type_MatchClass = new Dim_Type_Match();

        int exitCode = Dim_Type_MatchClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Type_Match.class.getClassLoader().getResourceAsStream("padel/dim_type_match_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Type_Match.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Type_Match");
        }
...
/************************************************************************************************
 *     84456 characters generated by Talend Open Studio for Data Integration 
 *     on the March 27, 2026 at 12:42:37 AM CET
 ************************************************************************************************/
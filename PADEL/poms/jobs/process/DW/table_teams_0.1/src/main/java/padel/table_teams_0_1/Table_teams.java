...
/**
 * Job: Table_teams Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Table_teams implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Table_teams";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Table_teams.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PADEL_Table_teams = new byte[0];
    static byte[] commonByteArray_PADEL_Table_teams = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PADEL_Table_teams.length) {
				if(length < 1024 && commonByteArray_PADEL_Table_teams.length == 0) {
   					commonByteArray_PADEL_Table_teams = new byte[1024];
				} else {
   					commonByteArray_PADEL_Table_teams = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PADEL_Table_teams, 0, length);
			strReturn = new String(commonByteArray_PADEL_Table_teams, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PADEL_Table_teams, 0, length);
			strReturn = new String(commonByteArray_PADEL_Table_teams, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PADEL_Table_teams) {
...
String tableName_tDBOutput_1 = "Dim_team1";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:27CVrSXd7csv8PAdHrDE/FUAXiDjZNaC6+wP6g==");
...
int count_tDBOutput_1=0;
                                ...
                                while(rsTable_tDBOutput_1.next()) {
                                    ...
                                    if(table_tDBOutput_1.equalsIgnoreCase("Dim_team1")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Team_1` VARCHAR(255)  ,`player1_t1` VARCHAR(255)  ,`player2_t1` VARCHAR(255)  )");
                                }

				String insert_tDBOutput_1 = "INSERT INTO `" + "Dim_team1" + "` (`Team_1`,`player1_t1`,`player2_t1`) VALUES (?,?,?)";
...
String tableName_tDBOutput_2 = "Dim_team2";
...
java.sql.Connection conn_tDBOutput_2 = null;
        ...
        String url_tDBOutput_2 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "DW_padel_analytics" + "?" + properties_tDBOutput_2;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:u7u1AfZduPPSk79Eq0J1wKefTXBuYf86wPv8GQ==");
...
int count_tDBOutput_2=0;
                                ...
                                java.sql.DatabaseMetaData dbMetaData_tDBOutput_2 = conn_tDBOutput_2.getMetaData();
                                    java.sql.ResultSet rsTable_tDBOutput_2 = dbMetaData_tDBOutput_2.getTables("DW_padel_analytics", null, null, new String[]{"TABLE"});
                                boolean whetherExist_tDBOutput_2 = false;
                                while(rsTable_tDBOutput_2.next()) {
                                    String table_tDBOutput_2 = rsTable_tDBOutput_2.getString("TABLE_NAME");
                                    if(table_tDBOutput_2.equalsIgnoreCase("Dim_team2")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
                                    stmtCreate_tDBOutput_2.execute("CREATE TABLE `" + tableName_tDBOutput_2 + "`(`Team_1` VARCHAR(255)  ,`player1_t1` VARCHAR(255)  ,`player2_t1` VARCHAR(255)  )");
                                }

				String insert_tDBOutput_2 = "INSERT INTO `" + "Dim_team2" + "` (`Team_1`,`player1_t1`,`player2_t1`) VALUES (?,?,?)";
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.Team_2 == null) ? 0 : this.Team_2.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									} else if (!this.Team_2.equals(other.Team_2))
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:RjkBKVBsPWgjQ88YKPbBTP0PYlfiOVqs5wFNmw==");
...
row2 = null;			
if(row1.Match_type == null){
	finder_tUniqRow_1.Match_type = null;
}else{
	finder_tUniqRow_1.Match_type = row1.Match_type.toLowerCase();
}
if(row1.Team_1 == null){
	finder_tUniqRow_1.Team_1 = null;
}else{
	finder_tUniqRow_1.Team_1 = row1.Team_1.toLowerCase();
}
if(row1.Team_2 == null){
	finder_tUniqRow_1.Team_2 = null;
}else{
	finder_tUniqRow_1.Team_2 = row1.Team_2.toLowerCase();
}	
...
if(row1.Match_type == null){
	new_tUniqRow_1.Match_type = null;
}else{
	new_tUniqRow_1.Match_type = row1.Match_type.toLowerCase();
}
if(row1.Team_1 == null){
	new_tUniqRow_1.Team_1 = null;
}else{
	new_tUniqRow_1.Team_1 = row1.Team_1.toLowerCase();
}
if(row1.Team_2 == null){
	new_tUniqRow_1.Team_2 = null;
}else{
	new_tUniqRow_1.Team_2 = row1.Team_2.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.Match_type = row1.Match_type;			row2.Team_1 = row1.Team_1;			row2.Team_2 = row1.Team_2;			row2.Winner = row1.Winner;			row2.Loser = row1.Loser;			row2.Score = row1.Score;			row2.Points__Winner = row1.Points__Winner;			row2.Prize__Winner = row1.Prize__Winner;			row2.Points__Loser = row1.Points__Loser;			row2.Prize__Loser = row1.Prize__Loser;			row2.Date = row1.Date;			row2.Tournament_Name = row1.Tournament_Name;			row2.Gender = row1.Gender;					
...
// # Output table : 'out1'
out1_tmp.Team_1 = row2.Team_1.replaceAll("\\s*\\(.*?\\)", "").trim();
out1_tmp.player1_t1 = Relational.ISNULL(row2.Team_1)|| row2.Team_1.equals("")|| !row2.Team_1.contains("/") ? row2.Team_1 : row2.Team_1.split("/")[0].replaceAll("\\s*\\(.*?\\)", "").trim() ;
out1_tmp.player2_t1 = Relational.ISNULL(row2.Team_1)|| row2.Team_1.equals("")|| !row2.Team_1.contains("/") ? "" : row2.Team_1.split("/")[1].replaceAll("\\s*\\(.*?\\)", "").trim() ;
out1 = out1_tmp;

// # Output table : 'out2'
out2_tmp.Team_1 = row2.Team_2.replaceAll("\\s*\\(.*?\\)", "").trim();
out2_tmp.player1_t1 = Relational.ISNULL(row2.Team_2)|| row2.Team_2.equals("")|| !row2.Team_2.contains("/") ? row2.Team_2 : row2.Team_2.split("/")[0].replaceAll("\\s*\\(.*?\\)", "").trim() ;
out2_tmp.player2_t1 = Relational.ISNULL(row2.Team_2)|| row2.Team_2.equals("")|| !row2.Team_2.contains("/") ? "" : row2.Team_2.split("/")[1].replaceAll("\\s*\\(.*?\\)", "").trim() ;
out2 = out2_tmp;
// ###############################
...
row3 = null;			
if(out1.Team_1 == null){
	finder_tUniqRow_2.Team_1 = null;
}else{
	finder_tUniqRow_2.Team_1 = out1.Team_1.toLowerCase();
}	
...
if(out1.Team_1 == null){
	new_tUniqRow_2.Team_1 = null;
}else{
	new_tUniqRow_2.Team_1 = out1.Team_1.toLowerCase();
}
		
		keystUniqRow_2.add(new_tUniqRow_2);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.Team_1 = out1.Team_1;			row3.player1_t1 = out1.player1_t1;			row3.player2_t1 = out1.player2_t1;					
...
} else {pstmt_tDBOutput_1.setString(1, row3.Team_1);
}

                            if(row3.player1_t1 == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row3.player1_t1);
}

                            if(row3.player2_t1 == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row3.player2_t1);
}
...
row4 = null;			
if(out2.Team_1 == null){
	finder_tUniqRow_3.Team_1 = null;
}else{
	finder_tUniqRow_3.Team_1 = out2.Team_1.toLowerCase();
}	
...
if(out2.Team_1 == null){
	new_tUniqRow_3.Team_1 = null;
}else{
	new_tUniqRow_3.Team_1 = out2.Team_1.toLowerCase();
}
		
		keystUniqRow_3.add(new_tUniqRow_3);if(row4 == null){ 
	
	row4 = new row4Struct();
}row4.Team_1 = out2.Team_1;			row4.player1_t1 = out2.player1_t1;			row4.player2_t1 = out2.player2_t1;					
...
} else {pstmt_tDBOutput_2.setString(1, row4.Team_1);
}

                            if(row4.player1_t1 == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, row4.player1_t1);
}

                            if(row4.player2_t1 == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, row4.player2_t1);
}
 ...
 */
    ...
    public static void main(String[] args){
        final Table_teams Table_teamsClass = new Table_teams();

        int exitCode = Table_teamsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Table_teams.class.getClassLoader().getResourceAsStream("padel/table_teams_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Table_teams.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Table_teams");
        }
...
/************************************************************************************************
 *     123969 characters generated by Talend Open Studio for Data Integration 
 *     on the March 27, 2026 at 12:42:44 AM CET
 ************************************************************************************************/
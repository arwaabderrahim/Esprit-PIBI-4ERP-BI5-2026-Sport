...
package padel.sa_padel_info_0_1;
 ...
 * @status
 */
public class SA_Padel_info implements TalendJob {
	...
	private final String jobName = "SA_Padel_info";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SA_Padel_info.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SA_Padel_info.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_PADEL_SA_Padel_info = new byte[0];
		static byte[] commonByteArray_PADEL_SA_Padel_info = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PADEL_SA_Padel_info.length) {
					if (length < 1024 && commonByteArray_PADEL_SA_Padel_info.length == 0) {
						commonByteArray_PADEL_SA_Padel_info = new byte[1024];
					} else {
						commonByteArray_PADEL_SA_Padel_info = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PADEL_SA_Padel_info, 0, length);
				strReturn = new String(commonByteArray_PADEL_SA_Padel_info, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PADEL_SA_Padel_info, 0, length);
				strReturn = new String(commonByteArray_PADEL_SA_Padel_info, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PADEL_SA_Padel_info) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "SA_Padel_Info";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:m2cfC2vdyMAiTPsjfZwneWm7sd3ECdDQNKYlzQ==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("SA_Padel_Info")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`Name` VARCHAR(255)  ,`Country` VARCHAR(255)  ,`Points` INT(10)  ,`Position` INT(10)  ,`Move` INT(10)  ,`Genre` VARCHAR(10)  )");
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "SA_Padel_Info"
						+ "` (`Name`,`Country`,`Points`,`Position`,`Move`,`Genre`) VALUES (?,?,?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:AkJmf8/c3hezCSsM0GkDJOvSuVzsu897XrRFdw==");
...
// # Output table : 'out1'
									out1_tmp.Name = null;
									out1_tmp.Country = null;
									out1_tmp.Points = null;
									out1_tmp.Position = null;
									out1_tmp.Move = null;
									out1_tmp.Genre = null;
									out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
								if (out1 != null) {
									...
									if (out1.Country == null) {
										...
										pstmt_tDBOutput_1.setString(2, out1.Country);
									}

									if (out1.Points == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(3, out1.Points);
									}

									if (out1.Position == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(4, out1.Position);
									}

									if (out1.Move == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(5, out1.Move);
									}

									if (out1.Genre == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(6, out1.Genre);
									}
...
// ###############################      
	...
	public static void main(String[] args) {
		final SA_Padel_info SA_Padel_infoClass = new SA_Padel_info();

		int exitCode = SA_Padel_infoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SA_Padel_info.class.getClassLoader()
					.getResourceAsStream("padel/sa_padel_info_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SA_Padel_info.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SA_Padel_info");
		}
...
/************************************************************************************************
 * 91003 characters generated by Talend Open Studio for Data Integration on the
 * March 24, 2026 at 4:58:59 PM CET
 ************************************************************************************************/
...
package padel.sa_padel_infoofc_0_1;
...
/**
 * Job: sa_padel_infoOFC Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class sa_padel_infoOFC implements TalendJob {
	...
	private final String jobName = "sa_padel_infoOFC";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					sa_padel_infoOFC.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(sa_padel_infoOFC.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class sa_padel_info_ofcStruct implements routines.system.IPersistableRow<sa_padel_info_ofcStruct> {
		final static byte[] commonByteArrayLock_PADEL_sa_padel_infoOFC = new byte[0];
		static byte[] commonByteArray_PADEL_sa_padel_infoOFC = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PADEL_sa_padel_infoOFC.length) {
					if (length < 1024 && commonByteArray_PADEL_sa_padel_infoOFC.length == 0) {
						commonByteArray_PADEL_sa_padel_infoOFC = new byte[1024];
					} else {
						commonByteArray_PADEL_sa_padel_infoOFC = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PADEL_sa_padel_infoOFC, 0, length);
				strReturn = new String(commonByteArray_PADEL_sa_padel_infoOFC, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PADEL_sa_padel_infoOFC, 0, length);
				strReturn = new String(commonByteArray_PADEL_sa_padel_infoOFC, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PADEL_sa_padel_infoOFC) {
		 ...
		 * Compare keys
		 */
		public int compareTo(sa_padel_info_ofcStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				sa_padel_info_ofcStruct sa_padel_info_ofc = new sa_padel_info_ofcStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "sa_padel_info_ofc");
				}
				...
				String tableName_tDBOutput_1 = "SA_Padel_Info_OFC";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:pC30iFsJMRaKq7P66MgpVwTVdLxdHFDguazkJA==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("SA_Padel_Info_OFC")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`title` VARCHAR(255)  ,`handle` VARCHAR(255)  ,`vendor` VARCHAR(255)  ,`product_type` VARCHAR(255)  ,`tags` VARCHAR(255)  ,`created_at` DATE ,`price` FLOAT(5,2)  ,`sku` INT(5)  ,`image` VARCHAR(164)  ,`weight` VARCHAR(255)  ,`shape` VARCHAR(255)  ,`foam` VARCHAR(255)  ,`collection` VARCHAR(255)  ,`game_level` VARCHAR(255)  ,`frame` VARCHAR(255)  ,`surface` VARCHAR(255)  ,`professional_player` VARCHAR(255)  ,`color` VARCHAR(255)  ,`racket_type` VARCHAR(255)  ,`balance` VARCHAR(255)  ,`gender` VARCHAR(255)  ,`racket_cover` VARCHAR(255)  ,`player_name` VARCHAR(200)  )");
				}
				String insert_tDBOutput_1 = "INSERT IGNORE INTO `" + "SA_Padel_Info_OFC"
						+ "` (`title`,`handle`,`vendor`,`product_type`,`tags`,`created_at`,`price`,`sku`,`image`,`weight`,`shape`,`foam`,`collection`,`game_level`,`frame`,`surface`,`professional_player`,`color`,`racket_type`,`balance`,`gender`,`racket_cover`,`player_name`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				sa_padel_info_ofcStruct sa_padel_info_ofc_tmp = new sa_padel_info_ofcStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:EZtgmbOK+tKXy/U2BPEYP/5MEutWIT2aMNuf/A==");
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
											...
											if (row_tFileInputExcel_1
													...
													&& org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(
															row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1
																	+ start_column_tFileInputExcel_1))) {
												row1.created_at = row_tFileInputExcel_1.getCell(
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.price = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
...
// Start of branch "row1"
							if (row1 != null) {
								...
								{ // start of Var scope
									...
									sa_padel_info_ofc = null;

// # Output table : 'sa_padel_info_ofc'
									sa_padel_info_ofc_tmp.title = row1.title;
									sa_padel_info_ofc_tmp.handle = row1.handle;
									sa_padel_info_ofc_tmp.vendor = row1.vendor;
									sa_padel_info_ofc_tmp.product_type = row1.product_type;
									sa_padel_info_ofc_tmp.tags = row1.tags;
									sa_padel_info_ofc_tmp.created_at = row1.created_at;
									sa_padel_info_ofc_tmp.price = row1.price;
									sa_padel_info_ofc_tmp.sku = row1.sku;
									sa_padel_info_ofc_tmp.image = row1.image;
									sa_padel_info_ofc_tmp.weight = row1.weight;
									sa_padel_info_ofc_tmp.shape = row1.shape;
									sa_padel_info_ofc_tmp.foam = row1.foam;
									sa_padel_info_ofc_tmp.collection = row1.collection;
									sa_padel_info_ofc_tmp.game_level = row1.game_level;
									sa_padel_info_ofc_tmp.frame = row1.frame;
									sa_padel_info_ofc_tmp.surface = row1.surface;
									sa_padel_info_ofc_tmp.professional_player = row1.professional_player;
									sa_padel_info_ofc_tmp.color = row1.color;
									sa_padel_info_ofc_tmp.racket_type = row1.racket_type;
									sa_padel_info_ofc_tmp.balance = row1.balance;
									sa_padel_info_ofc_tmp.gender = row1.gender;
									sa_padel_info_ofc_tmp.racket_cover = row1.racket_cover;
									sa_padel_info_ofc_tmp.player_name = row1.player_name;
									sa_padel_info_ofc = sa_padel_info_ofc_tmp;
// ###############################
								 ...
								 */
// Start of branch "sa_padel_info_ofc"
								if (sa_padel_info_ofc != null) {
									...
									if (sa_padel_info_ofc.title == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(1, sa_padel_info_ofc.title);
									}

									if (sa_padel_info_ofc.handle == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, sa_padel_info_ofc.handle);
									}

									if (sa_padel_info_ofc.vendor == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, sa_padel_info_ofc.vendor);
									}

									if (sa_padel_info_ofc.product_type == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, sa_padel_info_ofc.product_type);
									}

									if (sa_padel_info_ofc.tags == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, sa_padel_info_ofc.tags);
									}

									if (sa_padel_info_ofc.created_at != null) {
										date_tDBOutput_1 = sa_padel_info_ofc.created_at.getTime();
									...
									if (sa_padel_info_ofc.price == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.FLOAT);
									} else {
										pstmt_tDBOutput_1.setFloat(7, sa_padel_info_ofc.price);
									}

									if (sa_padel_info_ofc.sku == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(8, sa_padel_info_ofc.sku);
									}

									if (sa_padel_info_ofc.image == null) {
										pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(9, sa_padel_info_ofc.image);
									}

									if (sa_padel_info_ofc.weight == null) {
										pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(10, sa_padel_info_ofc.weight);
									}

									if (sa_padel_info_ofc.shape == null) {
										pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(11, sa_padel_info_ofc.shape);
									}

									if (sa_padel_info_ofc.foam == null) {
										pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(12, sa_padel_info_ofc.foam);
									}

									if (sa_padel_info_ofc.collection == null) {
										pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(13, sa_padel_info_ofc.collection);
									}

									if (sa_padel_info_ofc.game_level == null) {
										pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(14, sa_padel_info_ofc.game_level);
									}

									if (sa_padel_info_ofc.frame == null) {
										pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(15, sa_padel_info_ofc.frame);
									}

									if (sa_padel_info_ofc.surface == null) {
										pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(16, sa_padel_info_ofc.surface);
									}

									if (sa_padel_info_ofc.professional_player == null) {
										pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(17, sa_padel_info_ofc.professional_player);
									}

									if (sa_padel_info_ofc.color == null) {
										pstmt_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(18, sa_padel_info_ofc.color);
									}

									if (sa_padel_info_ofc.racket_type == null) {
										pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(19, sa_padel_info_ofc.racket_type);
									}

									if (sa_padel_info_ofc.balance == null) {
										pstmt_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(20, sa_padel_info_ofc.balance);
									}

									if (sa_padel_info_ofc.gender == null) {
										pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(21, sa_padel_info_ofc.gender);
									}

									if (sa_padel_info_ofc.racket_cover == null) {
										pstmt_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(22, sa_padel_info_ofc.racket_cover);
									}

									if (sa_padel_info_ofc.player_name == null) {
										pstmt_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(23, sa_padel_info_ofc.player_name);
									}
								...
								} // End of branch "sa_padel_info_ofc"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "sa_padel_info_ofc");
				}
	...
	public static void main(String[] args) {
		final sa_padel_infoOFC sa_padel_infoOFCClass = new sa_padel_infoOFC();

		int exitCode = sa_padel_infoOFCClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = sa_padel_infoOFC.class.getClassLoader()
					.getResourceAsStream("padel/sa_padel_infoofc_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = sa_padel_infoOFC.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : sa_padel_infoOFC");
		}
...
/************************************************************************************************
 * 101863 characters generated by Talend Open Studio for Data Integration on the
 * March 25, 2026 at 2:36:54 PM CET
 ************************************************************************************************/
...
package padel.master_job_padel_0_1;
...
/**
 * Job: master_job_padel Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class master_job_padel implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "master_job_padel";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				master_job_padel.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(master_job_padel.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		padel.dim_calendar_0_1.Dim_Calendar childJob_tRunJob_1 = new padel.dim_calendar_0_1.Dim_Calendar();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		padel.dim_type_match_0_1.Dim_Type_Match childJob_tRunJob_9 = new padel.dim_type_match_0_1.Dim_Type_Match();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		padel.dim_team_construc_0_1.Dim_team_construc childJob_tRunJob_7 = new padel.dim_team_construc_0_1.Dim_team_construc();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_11 = null;
		...
		padel.dim_vendor_0_1.Dim_Vendor childJob_tRunJob_11 = new padel.dim_vendor_0_1.Dim_Vendor();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		padel.dim_gender_0_1.Dim_Gender childJob_tRunJob_3 = new padel.dim_gender_0_1.Dim_Gender();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		padel.dim_countryy_0_1.Dim_Countryy childJob_tRunJob_2 = new padel.dim_countryy_0_1.Dim_Countryy();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		padel.dim_type_match_0_1.Dim_Type_Match childJob_tRunJob_10 = new padel.dim_type_match_0_1.Dim_Type_Match();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		padel.dim_padel_info_0_1.Dim_Padel_Info childJob_tRunJob_4 = new padel.dim_padel_info_0_1.Dim_Padel_Info();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		padel.dim_player_ofc_0_1.Dim_Player_ofc childJob_tRunJob_5 = new padel.dim_player_ofc_0_1.Dim_Player_ofc();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		padel.dim_team_ofc_0_1.Dim_team_ofc childJob_tRunJob_6 = new padel.dim_team_ofc_0_1.Dim_team_ofc();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_14 = null;
		...
		padel.table_teams_0_1.Table_teams childJob_tRunJob_14 = new padel.table_teams_0_1.Table_teams();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		padel.dim_tournmant_0_1.Dim_Tournmant childJob_tRunJob_8 = new padel.dim_tournmant_0_1.Dim_Tournmant();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_12 = null;
		...
		padel.fact_equipement_0_1.Fact_Equipement childJob_tRunJob_12 = new padel.fact_equipement_0_1.Fact_Equipement();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_13 = null;
		...
		padel.fact_performance_0_1.Fact_Performance childJob_tRunJob_13 = new padel.fact_performance_0_1.Fact_Performance();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final master_job_padel master_job_padelClass = new master_job_padel();

        int exitCode = master_job_padelClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = master_job_padel.class.getClassLoader().getResourceAsStream("padel/master_job_padel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = master_job_padel.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : master_job_padel");
        }
...
/************************************************************************************************
 *     122778 characters generated by Talend Open Studio for Data Integration 
 *     on the March 27, 2026 at 12:42:47 AM CET
 ************************************************************************************************/
...
/**
 * Job: Dim_Gender Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Gender implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Gender";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Gender.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Dim_GenderStruct implements routines.system.IPersistableRow<Dim_GenderStruct> {
    final static byte[] commonByteArrayLock_PADEL_Dim_Gender = new byte[0];
    static byte[] commonByteArray_PADEL_Dim_Gender = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.Id_gender == null) ? 0 : this.Id_gender.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final Dim_GenderStruct other = (Dim_GenderStruct) obj;
		
						if (this.Id_gender == null) {
							if (other.Id_gender != null)
								return false;
						
						} else if (!this.Id_gender.equals(other.Id_gender))
	...
	public void copyDataTo(Dim_GenderStruct other) {
	...
	public void copyKeysDataTo(Dim_GenderStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PADEL_Dim_Gender.length) {
				if(length < 1024 && commonByteArray_PADEL_Dim_Gender.length == 0) {
   					commonByteArray_PADEL_Dim_Gender = new byte[1024];
				} else {
   					commonByteArray_PADEL_Dim_Gender = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PADEL_Dim_Gender, 0, length);
			strReturn = new String(commonByteArray_PADEL_Dim_Gender, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PADEL_Dim_Gender, 0, length);
			strReturn = new String(commonByteArray_PADEL_Dim_Gender, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PADEL_Dim_Gender) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Gender = readString(dis);
						...
						this.Id_gender = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.Id_gender,dos);
     ...
     * Compare keys
     */
    public int compareTo(Dim_GenderStruct other) {
...
Dim_GenderStruct Dim_Gender = new Dim_GenderStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Dim_Gender");
					}
...
String tableName_tDBOutput_1 = "Dim_Gender";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tD/W4/LSUlTkBcyfunpoyebn2HmN5MIwvYqa+g==");
...
int count_tDBOutput_1=0;
                                ...
                                while(rsTable_tDBOutput_1.next()) {
                                    ...
                                    if(table_tDBOutput_1.equalsIgnoreCase("Dim_Gender")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Gender` VARCHAR(255)  ,`Id_gender` INT(10)  ,primary key(`Id_gender`))");
                                }

				String insert_tDBOutput_1 = "INSERT INTO `" + "Dim_Gender" + "` (`Gender`,`Id_gender`) VALUES (?,?)";
...
Dim_GenderStruct Dim_Gender_tmp = new Dim_GenderStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:9+xRxjzP3VAI8ytAF8+nZhTykALXT95hSiiudw==");
...
Dim_Gender_tmp.Gender = row2.Gender ;
Dim_Gender_tmp.Id_gender = Numeric.sequence("s1",1,1) ;
Dim_Gender = Dim_Gender_tmp;
...
if(Dim_Gender != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            if(Dim_Gender.Gender == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, Dim_Gender.Gender);
}

                            if(Dim_Gender.Id_gender == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, Dim_Gender.Id_gender);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Dim_Gender");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Gender Dim_GenderClass = new Dim_Gender();

        int exitCode = Dim_GenderClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Gender.class.getClassLoader().getResourceAsStream("padel/dim_gender_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Gender.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Gender");
        }
...
/************************************************************************************************
 *     85245 characters generated by Talend Open Studio for Data Integration 

...
package padel.dim_calendar_0_1;
...
/**
 * Job: Dim_Calendar Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Calendar implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Calendar";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Calendar.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class InsertStruct implements routines.system.IPersistableRow<InsertStruct> {
    final static byte[] commonByteArrayLock_PADEL_Dim_Calendar = new byte[0];
    static byte[] commonByteArray_PADEL_Dim_Calendar = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PADEL_Dim_Calendar.length) {
				if(length < 1024 && commonByteArray_PADEL_Dim_Calendar.length == 0) {
   					commonByteArray_PADEL_Dim_Calendar = new byte[1024];
				} else {
   					commonByteArray_PADEL_Dim_Calendar = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PADEL_Dim_Calendar, 0, length);
			strReturn = new String(commonByteArray_PADEL_Dim_Calendar, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PADEL_Dim_Calendar, 0, length);
			strReturn = new String(commonByteArray_PADEL_Dim_Calendar, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PADEL_Dim_Calendar) {
...
public static class UpdateStruct implements routines.system.IPersistableRow<UpdateStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.Id_Calendar;
	...
	public boolean equals(Object obj) {
		...
		final UpdateStruct other = (UpdateStruct) obj;
						...
						if (this.Id_Calendar != other.Id_Calendar)
							return false;
	...
	public void copyDataTo(UpdateStruct other) {
		...
		other.Id_Calendar = this.Id_Calendar;
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("Id_Calendar="+String.valueOf(Id_Calendar));
		sb.append(",Category="+Category);
	    sb.append("]");
    ...
    public int compareTo(UpdateStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.Id_Calendar, other.Id_Calendar);
						if(returnValue != 0) {
							return returnValue;
						}
...
String tableName_tDBOutput_1 = "dim_calendars";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4lMJaWU5WPFqIbhB94ixKtgy9755SYQGnFCsDA==");
...
int count_tDBOutput_1=0;
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "dim_calendars" + "` (`gender`,`Start_Date`,`End_Date`,`Event`,`Category`,`Date_Insert`) VALUES (?,?,?,?,?,?)";
...
String tableName_tDBOutput_2 = "dim_calendars";
...
java.sql.Connection conn_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:lrb0sg9S1wVsFUSTEwzOzpgdi4GnnuNn+qJ6cg==");
...
int count_tDBOutput_2=0;
	    ...
	    String update_tDBOutput_2 = "UPDATE `" + "dim_calendars" + "` SET `Category` = ? WHERE `Id_Calendar` = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:fOhbM9z/qALq5drIOGVab0RpcNopapZPoX/T6w==");
...
+"er`\nFROM `sa_cal`";
		    ...
		    while (rs_tDBInput_1.next()) {
				...
				if(rs_tDBInput_1.getString(1) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.Start_Date = rs_tDBInput_1.getTimestamp(1);
					} else {
				...
				if(rs_tDBInput_1.getString(2) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.End_Date = rs_tDBInput_1.getTimestamp(2);
					} else {
        	...
        	row1.Event = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
...
row2 = null;			
finder_tUniqRow_1.Start_Date = row1.Start_Date;
finder_tUniqRow_1.End_Date = row1.End_Date;
if(row1.Event == null){
...
new_tUniqRow_1.Start_Date = row1.Start_Date;
new_tUniqRow_1.End_Date = row1.End_Date;
if(row1.Event == null){
	...
	row2 = new row2Struct();
}row2.Start_Date = row1.Start_Date;			row2.End_Date = row1.End_Date;			row2.Event = row1.Event;			row2.Category = row1.Category;			row2.gender = row1.gender;					
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.Start_Date = row2.Start_Date  == null ? null : new java.util.Date(row2.Start_Date .getTime());
                        		    		
                        		    		    row3HashKey.End_Date = row2.End_Date  == null ? null : new java.util.Date(row2.End_Date .getTime());
                        		    		
                        		    		    row3HashKey.Event = row2.Event ;
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.Start_Date = '" + row3HashKey.Start_Date + "', row3.End_Date = '" + row3HashKey.End_Date + "', row3.Event = '" + row3HashKey.Event + "'");
								} // G 071
...
Var.Check_id = Relational.ISNULL(row3.Id_Calendar) || (row3.Id_Calendar==0)? "New" : "Old" ;// ###############################
        // ###############################
        // # Output tables
...
Var.Check_id.equals("New")

 ) {
Insert_tmp.gender = row2.gender ;
Insert_tmp.Start_Date = row2.Start_Date ;
Insert_tmp.End_Date = row2.End_Date ;
Insert_tmp.Event = row2.Event ;
Insert_tmp.Category = row2.Category ;
Insert_tmp.Date_Insert = null;
Insert = Insert_tmp;
...
Var.Check_id.equals("Old") &&  !row3.Category.equals( row2.Category )

 ) {
Update_tmp.Id_Calendar = row3.Id_Calendar ;
Update_tmp.Category = row2.Category ;
Update = Update_tmp;
} // closing filter/reject
// ###############################
...
if(Insert != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            if(Insert.gender == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, Insert.gender);
}

                            if(Insert.Start_Date != null) {
date_tDBOutput_1 = Insert.Start_Date.getTime();
...
pstmt_tDBOutput_1.setNull(2, java.sql.Types.DATE);
                            ...
                            if(Insert.End_Date != null) {
date_tDBOutput_1 = Insert.End_Date.getTime();
if(date_tDBOutput_1 < year1_tDBOutput_1 || date_tDBOutput_1 >= year10000_tDBOutput_1) {
...
pstmt_tDBOutput_1.setNull(3, java.sql.Types.DATE);
                            ...
                            if(Insert.Event == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, Insert.Event);
}

                            if(Insert.Category == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, Insert.Category);
}

                            if(Insert.Date_Insert != null) {
date_tDBOutput_1 = Insert.Date_Insert.getTime();
if(date_tDBOutput_1 < year1_tDBOutput_1 || date_tDBOutput_1 >= year10000_tDBOutput_1) {
...
} else {pstmt_tDBOutput_2.setString(1, Update.Category);
}


                    pstmt_tDBOutput_2.setInt(2 + count_tDBOutput_2, Update.Id_Calendar);
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.Id_Calendar = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.Id_Calendar);
    ...
    public int compareTo(row3Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.Event, other.Event);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:NHzBL9aif18xOlVBsfSbvaXUkZ6pvvDPCkfGFw==");
        ...
        String url_tDBInput_2 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "DW_padel_analytics" + "?" + properties_tDBInput_2;
		    ...
		    String dbquery_tDBInput_2 = "SELECT \n  `dim_calendars`.`Id_Calendar`, \n  `dim_calendars`.`gender`, \n  `dim_calendars`.`Start_Date`, \n  `dim_calendar"
+"s`.`End_Date`, \n  `dim_calendars`.`Event`, \n  `dim_calendars`.`Category`\nFROM `dim_calendars`";
            ...
            row3.Id_Calendar = rs_tDBInput_2.getInt(1);
        	...
        	row3.gender = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
				...
				if(rs_tDBInput_2.getString(3) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row3.Start_Date = rs_tDBInput_2.getTimestamp(3);
					} else {
						row3.Start_Date = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row3.Start_Date =  null;
				}
				...
				if(rs_tDBInput_2.getString(4) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row3.End_Date = rs_tDBInput_2.getTimestamp(4);
					} else {
						row3.End_Date = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row3.End_Date =  null;
				}
        	...
        	row3.Event = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 6) {
								row3.Category = null;
							} else {
	                         		
        	row3.Category = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.Id_Calendar = row3.Id_Calendar;
				...
				row3_HashRow.Event = row3.Event;
				
				row3_HashRow.Category = row3.Category;
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Calendar Dim_CalendarClass = new Dim_Calendar();

        int exitCode = Dim_CalendarClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Calendar.class.getClassLoader().getResourceAsStream("padel/dim_calendar_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Calendar.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Calendar");
        }
...
/************************************************************************************************
 *     129485 characters generated by Talend Open Studio for Data Integration 
 *     on the March 27, 2026 at 12:42:33 AM CET
 ************************************************************************************************/
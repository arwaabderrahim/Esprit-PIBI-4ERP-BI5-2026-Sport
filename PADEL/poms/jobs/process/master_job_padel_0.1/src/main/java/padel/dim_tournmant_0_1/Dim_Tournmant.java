...
package padel.dim_tournmant_0_1;
...
/**
 * Job: Dim_Tournmant Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Dim_Tournmant implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_Tournmant";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_Tournmant.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Tournmant.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Dim_TounmantStruct implements routines.system.IPersistableRow<Dim_TounmantStruct> {
    final static byte[] commonByteArrayLock_PADEL_Dim_Tournmant = new byte[0];
    static byte[] commonByteArray_PADEL_Dim_Tournmant = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.Id_tr_name;
	...
	public boolean equals(Object obj) {
		...
		final Dim_TounmantStruct other = (Dim_TounmantStruct) obj;
		
						if (this.Id_tr_name != other.Id_tr_name)
							return false;
	...
	public void copyDataTo(Dim_TounmantStruct other) {
	...
	public void copyKeysDataTo(Dim_TounmantStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PADEL_Dim_Tournmant.length) {
				if(length < 1024 && commonByteArray_PADEL_Dim_Tournmant.length == 0) {
   					commonByteArray_PADEL_Dim_Tournmant = new byte[1024];
				} else {
   					commonByteArray_PADEL_Dim_Tournmant = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PADEL_Dim_Tournmant, 0, length);
			strReturn = new String(commonByteArray_PADEL_Dim_Tournmant, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PADEL_Dim_Tournmant, 0, length);
			strReturn = new String(commonByteArray_PADEL_Dim_Tournmant, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PADEL_Dim_Tournmant) {
     ...
     * Compare keys
     */
    public int compareTo(Dim_TounmantStruct other) {

		int returnValue = -1;
		
						returnValue = checkNullsAndCompare(this.Id_tr_name, other.Id_tr_name);
						if(returnValue != 0) {
							return returnValue;
						}
...
Dim_TounmantStruct Dim_Tounmant = new Dim_TounmantStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Dim_Tounmant");
					}
...
String tableName_tDBOutput_1 = "Dim_Tournmant";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:PG33jqAq5E018TJglq6FEbsMXvDzj2WXPrfzdA==");
...
int count_tDBOutput_1=0;
                                ...
                                while(rsTable_tDBOutput_1.next()) {
                                    ...
                                    if(table_tDBOutput_1.equalsIgnoreCase("Dim_Tournmant")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Tournament_Name` VARCHAR(255)  ,`Id_tr_name` INT(10)   not null ,primary key(`Id_tr_name`))");
                                }

				String insert_tDBOutput_1 = "INSERT INTO `" + "Dim_Tournmant" + "` (`Tournament_Name`,`Id_tr_name`) VALUES (?,?)";
...
Dim_TounmantStruct Dim_Tounmant_tmp = new Dim_TounmantStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:h/053kE3wqmPkIMeQPzj1gl0/cViYxvDLQf46g==");
...
row2 = null;			
if(row1.Tournament_Name == null){
	finder_tUniqRow_1.Tournament_Name = null;
}else{
	finder_tUniqRow_1.Tournament_Name = row1.Tournament_Name.toLowerCase();
}	
...
if(row1.Tournament_Name == null){
	new_tUniqRow_1.Tournament_Name = null;
}else{
	new_tUniqRow_1.Tournament_Name = row1.Tournament_Name.toLowerCase();
}
...
// # Output table : 'Dim_Tounmant'
Dim_Tounmant_tmp.Tournament_Name = row2.Tournament_Name ;
Dim_Tounmant_tmp.Id_tr_name = Numeric.sequence("s1",1,1) ;
Dim_Tounmant = Dim_Tounmant_tmp;
// ###############################
 ...
 */
// Start of branch "Dim_Tounmant"
if(Dim_Tounmant != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            if(Dim_Tounmant.Tournament_Name == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, Dim_Tounmant.Tournament_Name);
}

                            pstmt_tDBOutput_1.setInt(2, Dim_Tounmant.Id_tr_name);
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Dim_Tounmant");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Tournmant Dim_TournmantClass = new Dim_Tournmant();

        int exitCode = Dim_TournmantClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Tournmant.class.getClassLoader().getResourceAsStream("padel/dim_tournmant_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Tournmant.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Tournmant");
        }
...
/************************************************************************************************
 *     84426 characters generated by Talend Open Studio for Data Integration 
